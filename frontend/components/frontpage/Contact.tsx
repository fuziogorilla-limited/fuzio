...
const CONTACT = {
  ...
  location: {
    city: "Nairobi",
    country: "Kenya",
    description: "Warehouse and dispatch operations based in Nairobi.",
  },
  workingHours: {
...
const CONTACT_RESPONSE_POINTS = [
  { title: "Stock confirmation", body: "We confirm whether the products and quantities you need are available." },
  { title: "Clear pricing", body: "For larger orders, we can provide a quotation based on your actual requirements." },
  { title: "Delivery information", body: "We confirm the delivery method, location and cost before your order moves." },
] as const;

const ENQUIRY_TYPES = [
  { value: "product", label: "Product enquiry" },
  { value: "bulk", label: "Bulk order / quotation" },
